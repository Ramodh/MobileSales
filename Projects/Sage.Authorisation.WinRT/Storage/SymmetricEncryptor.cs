...
namespace Sage.Authorisation.WinRT.Storage
{
    ...
    internal class SymmetricEncryptor
    {
        ...
        /// </summary>
        private EncryptionKeyStore _keyManager;
        ...
        /// <returns>Returns a Task&lt;string&gt; which represents an asynchronus operation. The cypher text is returned on completion of the Task</returns>
        ...
        /// <returns>Returns a Task&lt;string&gt; which represents an asynchronus operation. The clear text is returned on completion of the Task</returns>
