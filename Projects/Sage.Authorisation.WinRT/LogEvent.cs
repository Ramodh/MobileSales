...
{
    /// <summary>
    /// Contains information about the log event, specifically a <see cref="Sage.Authorisation.WinRT.LogEventType">event type</see>,
    /// a <see cref="Sage.Authorisation.WinRT.LogLevel">log level</see> and a <see cref="Sage.Authorisation.WinRT.LogEvent.Message">message.</see>
    /// </summary>
