...
namespace Sage.Authorisation.WinRT.Exceptions
{
    ...
    /// </summary>
    /// <remarks>
    /// The server response did not contain the expected redirect location. This may be due to a temporary server problem, invalid or expired credential,
    ...
    /// <para>Web proxy servers may also interfere with HTTP redirects and cause these exceptions, expecially if proxy server filters HTTP response headers.</para>
    /// </remarks>
