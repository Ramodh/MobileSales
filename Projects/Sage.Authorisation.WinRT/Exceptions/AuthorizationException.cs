...
namespace Sage.Authorisation.WinRT.Exceptions
{
    internal class AuthorisationException : Exception
    {
        ...
        /// <summary>
        ///     Gets any state information that was supplied as part of the authorisation request. Please note, State may not
        ///     always be available depending on the nature of the exception.
        /// </summary>
